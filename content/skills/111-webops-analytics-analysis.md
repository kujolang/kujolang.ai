...
section: "Agent Skill"
order: "1110"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/webops-analytics-analysis ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-analytics-analysis/SKILL.md"
...
Use when analyzing real website behavior from normalized analytics evidence.
...
- [Read the complete webops-analytics-analysis skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-analytics-analysis/SKILL.md)
