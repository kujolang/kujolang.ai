...
section: "Agent Skill"
order: "1310"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/webops-search-standards-watch ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-search-standards-watch/SKILL.md"
...
keywords: "WebOps Search Standards Watch, Kujo Agent Skill, webops-search-standards-watch, repository-backed agent guidance"
seo_title: "WebOps Search Standards Watch — Kujo Agent Skill"
seo_description: "Use when monitoring authoritative search, indexing, structured-data, analytics, browser, AI-search, and web-standard changes."
---

## What it covers

Use when monitoring authoritative search, indexing, structured-data, analytics, browser, AI-search, and web-standard changes.
...
- [Read the complete webops-search-standards-watch skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-search-standards-watch/SKILL.md)
