---
title: "VideoOps media compositing"
custom_url: "videoops-media-compositing"
description: "Use when placing and trimming approved image, video, GIF-derived, and audio assets."
excerpt: "Use when placing and trimming approved image, video, GIF-derived, and audio assets."
featured_image: "/assets/images/ecosystem/skills-agent-guidance-library.webp"
social_image: "/assets/images/social/videoops-media-compositing.jpg"
section: "Agent Skill"
order: "920"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/videoops-media-compositing ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/videoops-media-compositing/SKILL.md"
...
keywords: "VideoOps media compositing, Kujo Agent Skill, videoops-media-compositing, repository-backed agent guidance"
seo_title: "VideoOps media compositing — Kujo Agent Skill"
seo_description: "Use when placing and trimming approved image, video, GIF-derived, and audio assets."
---

## What it covers

Use when placing and trimming approved image, video, GIF-derived, and audio assets.
...
- [Read the complete videoops-media-compositing skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/videoops-media-compositing/SKILL.md)
