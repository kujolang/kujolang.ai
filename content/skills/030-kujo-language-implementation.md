...
section: "Agent Skill"
order: "300"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/kujo-language-implementation ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-language-implementation/SKILL.md"
...
- [Read the complete kujo-language-implementation skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-language-implementation/SKILL.md)
