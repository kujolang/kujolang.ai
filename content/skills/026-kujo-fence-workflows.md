...
section: "Agent Skill"
order: "260"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/kujo-fence-workflows ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-fence-workflows/SKILL.md"
...
keywords: "Kujo Fence, Kujo Agent Skill, kujo-fence-workflows, repository-backed agent guidance"
seo_title: "Kujo Fence — Kujo Agent Skill"
...
- [Read the complete kujo-fence-workflows skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-fence-workflows/SKILL.md)
