...
section: "Agent Skill"
order: "200"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/kujo-docgen-public-docs-refresh ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-docgen-public-docs-refresh/SKILL.md"
...
- [Read the complete kujo-docgen-public-docs-refresh skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/kujo-docgen-public-docs-refresh/SKILL.md)
