...
section: "Agent Skill"
order: "1210"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/webops-distribution ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-distribution/SKILL.md"
...
Use when creating source-grounded distribution assets and optionally publishing with ACT authority.
...
- [Read the complete webops-distribution skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-distribution/SKILL.md)
