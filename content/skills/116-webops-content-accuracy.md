...
section: "Agent Skill"
order: "1160"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/webops-content-accuracy ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-content-accuracy/SKILL.md"
...
keywords: "WebOps Content Accuracy, Kujo Agent Skill, webops-content-accuracy, repository-backed agent guidance"
seo_title: "WebOps Content Accuracy — Kujo Agent Skill"
seo_description: "Use when reviewing website claims for outdated or invalid guidance."
---

## What it covers

Use when reviewing website claims for outdated or invalid guidance.
...
- [Read the complete webops-content-accuracy skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-content-accuracy/SKILL.md)
