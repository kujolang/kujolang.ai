...
section: "Agent Skill"
order: "1220"
install_command: "git clone --branch v0.7.0 --depth 1 https://github.com/kujolang/kujo-skills.git && mkdir -p ~/.codex/skills && cp -R kujo-skills/skills/webops-indexation ~/.codex/skills/"
github_url: "https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-indexation/SKILL.md"
...
Use when auditing crawlability, local indexability, and confirmed provider index state.
...
- [Read the complete webops-indexation skill on GitHub](https://github.com/kujolang/kujo-skills/blob/v0.7.0/skills/webops-indexation/SKILL.md)
