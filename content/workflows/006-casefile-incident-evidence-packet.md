...
order: "60"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && casefile-incident-evidence-packet/scripts/run-workflow.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/casefile-incident-evidence-packet"
...
- [Open the complete casefile-incident-evidence-packet workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/casefile-incident-evidence-packet)
