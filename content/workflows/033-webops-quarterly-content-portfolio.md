...
order: "330"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && webops-quarterly-content-portfolio/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-quarterly-content-portfolio"
...
- [Open the complete webops-quarterly-content-portfolio workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-quarterly-content-portfolio)
