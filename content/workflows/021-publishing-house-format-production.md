...
order: "210"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && publishing-house-format-production/bin/run"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/publishing-house-format-production"
...
- [Open the complete publishing-house-format-production workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/publishing-house-format-production)
