...
order: "250"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && rag-enterprise-knowledge-gate/scripts/run-workflow.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/rag-enterprise-knowledge-gate"
...
- [Open the complete rag-enterprise-knowledge-gate workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/rag-enterprise-knowledge-gate)
