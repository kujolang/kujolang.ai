...
order: "80"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && docsgen-repo-contract-runner/scripts/run-workflow.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/docsgen-repo-contract-runner"
...
- [Open the complete docsgen-repo-contract-runner workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/docsgen-repo-contract-runner)
