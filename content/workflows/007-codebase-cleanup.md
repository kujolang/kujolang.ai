...
order: "70"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && codebase-cleanup/scripts/run-workflow.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/codebase-cleanup"
...
- [Open the complete codebase-cleanup workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/codebase-cleanup)
