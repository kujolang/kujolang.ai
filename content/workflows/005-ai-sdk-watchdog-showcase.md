...
order: "50"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && ai-sdk-watchdog-showcase/scripts/run-showcase.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/ai-sdk-watchdog-showcase"
...
- [Open the complete ai-sdk-watchdog-showcase workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/ai-sdk-watchdog-showcase)
