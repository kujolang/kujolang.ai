---
title: "Publishing House Primary Piece"
custom_url: "publishing-house-primary-piece"
description: "Create and package the authoritative evidence-linked primary artifact."
...
order: "240"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && publishing-house-primary-piece/bin/run"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/publishing-house-primary-piece"
...
keywords: "Publishing House Primary Piece, Kujo workflow, publishing-house-primary-piece, local-first agent workflow"
seo_title: "Publishing House Primary Piece — Kujo Workflow"
seo_description: "Create and package the authoritative evidence-linked primary artifact."
---

## Outcome

Create and package the authoritative evidence-linked primary artifact.
...
- [Open the complete publishing-house-primary-piece workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/publishing-house-primary-piece)
