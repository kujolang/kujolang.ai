...
social_image: "/assets/images/social/webops-monthly-seo-review.jpg"
section: "production capable with limitations"
order: "310"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && webops-monthly-seo-review/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-monthly-seo-review"
...
- [Open the complete webops-monthly-seo-review workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-monthly-seo-review)
