...
order: "300"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && webops-finding-to-fix/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-finding-to-fix"
...
- [Open the complete webops-finding-to-fix workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-finding-to-fix)
