...
order: "20"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && agency-runner/bin/agency-loop"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/agency-runner"
...
- [Open the complete agency-runner workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/agency-runner)
