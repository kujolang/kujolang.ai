...
order: "290"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && webops-content-refresh/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-content-refresh"
...
- [Open the complete webops-content-refresh workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-content-refresh)
