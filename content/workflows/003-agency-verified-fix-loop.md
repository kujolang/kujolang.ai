...
order: "30"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && agency-verified-fix-loop/scripts/run-loop.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/agency-verified-fix-loop"
...
- [Open the complete agency-verified-fix-loop workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/agency-verified-fix-loop)
