...
order: "340"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && webops-site-bootstrap/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-site-bootstrap"
...
- [Open the complete webops-site-bootstrap workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/webops-site-bootstrap)
