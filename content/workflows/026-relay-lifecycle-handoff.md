...
order: "260"
install_command: "git clone --branch v0.6.0 --depth 1 https://github.com/kujolang/kujo-workflows.git && cd kujo-workflows && relay-lifecycle-handoff/scripts/run.sh"
github_url: "https://github.com/kujolang/kujo-workflows/tree/v0.6.0/relay-lifecycle-handoff"
...
- [Open the complete relay-lifecycle-handoff workflow kit on GitHub](https://github.com/kujolang/kujo-workflows/tree/v0.6.0/relay-lifecycle-handoff)
