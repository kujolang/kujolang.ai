...
| --- | --- | --- | --- |
| Publishing House mobile document width | 1,059px in a 390px viewport | 390px in a 390px public viewport | Lens `dom-summary.json` |
...
| Public canonical responses | 192 baseline pages preserved | 192 of 192 returned HTTP 200 after deployment | `after-summary.json` |
| Docs production route | Existing fixture-only framing | Live adapter/recovery guidance returned HTTP 200 and passed mobile Lens checks | public docs receipt and Lens report |
