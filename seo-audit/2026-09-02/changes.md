...
- Prevented intrinsic grid content from widening `.tool-body` beyond its mobile
...
- Kept provider credentials and repository effects as deployment configuration
  instead of claiming they ship inside the site or operator.
