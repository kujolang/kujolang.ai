...
require_text "${output_dir}/install.sh" 'readonly DEFAULT_RELEASE_VERSION="${KUJO_RELEASE_VERSION:-v1.5.0}"'
...
reject_text "${output_dir}/index.html" 'class="home-agent-platform"'
require_text "${output_dir}/index.html" 'data-copy-status data-scramble-skip'
require_text "${output_dir}/providers/index.html" 'src="/assets/images/providers-routing-switchboard.webp"'
require_text "${output_dir}/providers/index.html" 'width="1916" height="821"'
require_text "${output_dir}/assets/css/style.css" '.provider-modal__dialog::-webkit-scrollbar'
require_text "${output_dir}/assets/css/style.css" 'scrollbar-color: var(--sk-code-border) var(--sk-code-surface)'
reject_text "${output_dir}/assets/css/style.css" 'box-shadow: .4rem .4rem 0 var(--sk-text-primary)'
...
require_text "${output_dir}/assets/js/site.js" 'Math.ceil(media.clientWidth / 4)'
require_text "${output_dir}/assets/js/site.js" 'now - lastTick >= 1000 / 4'
reject_text "${output_dir}/assets/js/site.js" 'now - lastTick >= 1000 / 14'
